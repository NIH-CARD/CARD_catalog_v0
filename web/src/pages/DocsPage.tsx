...
// columns change.
const SECTIONS = [
  { id: "table-schemas", label: "Table Schemas" },
  { id: "fair-compliance", label: "GitHub Repository FAIR Compliance" },
...
export function DocsPage() {
  return (
    ...
    <div className="space-y-12 text-slate-800">
      ...
      {/* Overview */}
      <section>
        <h1 className="text-2xl font-bold mb-3">Docs</h1>
        <p className="text-sm leading-relaxed text-slate-700">
          Reference documentation for how CARD Catalog's data is collected, processed, and
          structured — table schemas, FAIR scoring, AI-generated fields, and the pipeline
          methodology. Looking for the project pitch and user stories instead? See{" "}
      ...
      {/* FAIR Compliance */}
      <section id="fair-compliance">
        <h2 className="text-xl font-semibold mb-3">GitHub Repository FAIR Compliance</h2>
