    ...
    def run(
        ...
        *,
        ...
        if new_pmc_links:
            ...
            models_result = dg_models.run_integrated_batch_processing(
                url_list=new_pmc_links,
                batch_file_path='',
                output_file_path=models_batch_output_path,
            ...
            if isinstance(models_result, dict) and models_result.get("output_file_path"):
                models_df = _model_batch_results_to_df(dg_models, models_result["output_file_path"])
                ...
                logger.error(f"Model batch did not complete successfully: {models_result}")
                models_df = None
